      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div className="max-w-3xl z-10">
            ...
            <h1 className="text-6xl md:text-7xl font-bold tracking-tight leading-[1.1] mb-8 text-white">
              Ship Content <br />
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              <Link href="/login" className="btn-primary text-white px-8 py-4 rounded-full font-bold text-base flex items-center justify-center gap-2 group">
                Get Started Free
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Link>
              <button className="glass hover:bg-white/5 text-white px-8 py-4 rounded-full font-bold text-base transition-all flex items-center justify-center gap-2 border border-white/10 hover:border-white/20">
